---
tags:
  - Apache Kafka, Apache Pulsar, Apache ActiveMQ, ActiveMQ Artemis, NATS, MQTT, RabbitMQ, Amazon SQS, Google Cloud Pub/Sub, IBM MQ, AMQP, JMS, security, AI
  - Operating, optimizing and scaling
level: Intermediate
title: "When the Network Stops Behaving. Messaging Lessons from Autonomous Systems at Sea"
speakers:
- _participants/Alex-Kritikos.md
